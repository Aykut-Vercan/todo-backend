...
import com.example.springboot.todos.service.AdminService;
...
public class AdminController {
    ...
    @Operation(summary = "Get all user", description = "Retrieve a list of all users in the system")
    ...
    @Operation(summary = "Get all user", description = "Promote user to admin role")
    @ResponseStatus(HttpStatus.OK)
    ...
    public void deleteUser(@PathVariable @Min(1) long userId) {
        adminService.deleteNonAdmin(userId);
    }
